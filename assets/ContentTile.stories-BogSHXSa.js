import{j as t}from"./jsx-runtime-Cj5qKl0R.js";import{r as F}from"./iframe-FJBEzNyc.js";import{B}from"./Badge-pm-uv7Tj.js";import{F as M}from"./FeaturedLink-DhhOnDJX.js";import{I as L}from"./Icon-p0QnF2I5.js";import{c as o}from"./cn-B2SrrX3i.js";import"./preload-helper-PPVm8Dsz.js";const n=({title:e,className:i,description:$,cta:a,feature:l,featureType:N="image",featureIcons:d,centerFeature:p,badges:u,onClick:I,featureClassName:j,titleClassName:W,descriptionClassName:D,ctaClassName:_,featurePadding:S=!0,encapsulated:m=!0})=>{const P=F.useCallback(()=>{a&&(I?I(a.url):window.location.href=a.url)},[I,a]),q=F.useMemo(()=>l?N==="image"?t.jsxs("div",{className:o("content-tile__feature relative p-3 h-[200px] pb-0 flex items-end justify-center overflow-hidden rounded-lg bg-neutral-100 dark:bg-neutral-1200 border border-neutral-300 dark:border-neutral-1000 transition-[border-color,height]",p&&"items-center pb-3",a&&!m&&"group-hover/content-tile:border-neutral-500 dark:group-hover/content-tile:border-neutral-800 transition-colors",j),children:[t.jsx("div",{className:o("flex justify-center max-h-[200px]",!p&&"[&_img]:min-w-max [&_img]:h-[200px]",S&&!p&&"pt-6"),children:l}),d&&d?.length>0&&t.jsx("div",{className:"absolute bottom-3 right-3 flex gap-1.5 bg-neutral-000 dark:bg-neutral-1300 rounded border border-neutral-200 dark:border-neutral-1100 px-2 py-1.5",children:d.map((s,A)=>t.jsx(L,{name:s,size:"18px"},s+A))})]}):N==="icon"?t.jsx("div",{className:o("h-9",j),children:typeof l=="string"?t.jsx(L,{name:l,size:"36px"}):l}):null:null,[p,l,j,d,m,S,N,a]);return t.jsxs("div",{className:o("group/content-tile",m&&"p-5 border border-neutral-300 dark:border-neutral-1000 rounded-lg",a&&"cursor-pointer",a&&m&&"hover:border-neutral-500 dark:hover:border-neutral-800 transition-colors",i),...a&&{onClick:P,onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),P())},tabIndex:0,role:"link","aria-label":e},children:[q,t.jsxs("div",{className:"content-tile__content pr-4",children:[e&&t.jsx("h2",{className:o("content-tile__title mb-2 ui-text-h4 text-neutral-1300 dark:text-neutral-000",l&&"mt-4",W),children:e}),$&&t.jsx("div",{className:o("content-tile__description ui-text-p2 text-neutral-1000 dark:text-neutral-300",a&&"text-neutral-800 dark:text-neutral-500 group-hover/content-tile:text-neutral-1000 dark:group-hover/content-tile:text-neutral-300 transition-colors",(u||a&&!a.implicit)&&"mb-2",D),children:$}),u&&u.length>0&&t.jsx("div",{className:"content-tile__badges mb-2 flex flex-wrap gap-2",children:u.map(({label:s,className:A,...V},E)=>t.jsx(B,{className:o("uppercase text-[10px]",A),...V,children:s},s+E))}),a&&!a.implicit&&t.jsx(M,{url:"#",additionalCSS:o("py-0 pointer-events-none font-medium items-center text-neutral-800 dark:text-neutral-500 group-hover/content-tile:text-neutral-1300 dark:group-hover/content-tile:text-neutral-000 transition-colors [&_svg]:group-hover/content-tile:left-0",_),iconColor:"text-orange-600",children:a.text})]})]})};try{n.displayName="ContentTile",n.__docgenInfo={description:"",displayName:"ContentTile",filePath:"/home/runner/work/website/website/packages/ui/src/core/ContentTile.tsx",methods:[],props:{title:{defaultValue:null,declarations:[{fileName:"ui/src/core/ContentTile.tsx",name:"TypeLiteral"}],description:"The title text to display",name:"title",required:!1,tags:{},type:{name:"string"}},className:{defaultValue:null,declarations:[{fileName:"ui/src/core/ContentTile.tsx",name:"TypeLiteral"}],description:"Additional CSS classes for the root container",name:"className",required:!1,tags:{},type:{name:"string"}},description:{defaultValue:null,declarations:[{fileName:"ui/src/core/ContentTile.tsx",name:"TypeLiteral"}],description:"The description content to display (text or React elements)",name:"description",required:!1,tags:{},type:{name:"ReactNode"}},cta:{defaultValue:null,declarations:[{fileName:"ui/src/core/ContentTile.tsx",name:"TypeLiteral"}],description:`Call-to-action configuration.
