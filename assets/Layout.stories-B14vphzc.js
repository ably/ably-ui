import{i as e}from"./preload-helper-CT_b8DTk.js";import{Jt as t}from"./iframe-BwCxeFni.js";import{t as n}from"./jsx-runtime-TD5IgBxr.js";var r,i,a,o,s,c,l,u,d;e((()=>{t(),r=n(),i={title:`Styles/Layout`},a={render:()=>(0,r.jsx)(`div`,{className:`ui-standard-container mb-8`,children:(0,r.jsx)(`div`,{className:`bg-mid-grey align-center p-8`,children:(0,r.jsx)(`p`,{className:`ui-text-h3 text-center`,children:`ui-standard-container`})})}),parameters:{docs:{description:{story:"Container that does not grow beyond the xl breakpoint (1440px), centers and contains the correct outside padding across viewport changes. Usage: `.ui-standard-container`"}}}},o={render:()=>(0,r.jsx)(`div`,{className:`ui-standard-container mb-8`,children:(0,r.jsx)(`div`,{className:`bg-mid-grey align-center p-8`,children:(0,r.jsxs)(`div`,{className:`grid grid-cols-4 ui-grid-gap`,children:[(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`1`}),(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`2`}),(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`3`}),(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`4`})]})})}),parameters:{docs:{description:{story:"Add correct gaps across viewport changes. Usage: `.ui-grid-gap`"}}}},s={render:()=>(0,r.jsx)(`div`,{className:`ui-standard-container mb-8`,children:(0,r.jsx)(`div`,{className:`bg-mid-grey align-center p-8`,children:(0,r.jsx)(`div`,{className:`ui-grid-px`,children:(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`Text`})})})}),parameters:{docs:{description:{story:"Add padding on the x axis, with correct values across viewport changes. Usage: `.ui-grid-px`"}}}},c={render:()=>(0,r.jsx)(`div`,{className:`ui-standard-container mb-8`,children:(0,r.jsx)(`div`,{className:`bg-mid-grey align-center p-8`,children:(0,r.jsx)(`div`,{className:`ui-grid-mx`,children:(0,r.jsx)(`div`,{className:`bg-cool-black text-white font-sans p-8 text-center`,children:`Text`})})})}),parameters:{docs:{description:{story:"Add margin on the x axis, with correct values across viewport changes. Usage: `.ui-grid-mx`"}}}},l={render:()=>(0,r.jsx)(`div`,{className:`overflow-x-hidden`,children:(0,r.jsx)(`div`,{className:`ui-standard-container mb-8`,children:(0,r.jsx)(`div`,{className:`bg-[linear-gradient(to_right,cyan_49.9%,blue_50%,cyan_50.1%)] align-center p-8 ui-full-container-override text-white`,children:(0,r.jsx)(`div`,{children:[...Array(20)].map((e,t)=>(0,r.jsx)(`span`,{className:`mx-2 rounded-lg bg-cool-black p-4`,children:`Content`},t))})})})}),parameters:{docs:{description:{story:`Somewhat niche override for situations where you would like an element to break out from inside a container and occupy the whole width of the page. The dark blue line here shows that the element is centered, but the content starts from the left hand edge.
