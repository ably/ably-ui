      ...
      def company_logos
        {
          ...
          lightspeed: {
            name: "Lightspeed",
            logo: asset_path("ably_ui/core/images/cust-logo-lightspeed-syst-col-pos.png"),
            logo2x: asset_path("ably_ui/core/images/cust-logo-lightspeed-syst-col-pos@2x.png"),
          },
          australian_open: {
            name: "Australian Open",
            logo: asset_path("ably_ui/core/images/cust-logo-ausopen-col-pos.png"),
            logo2x: asset_path("ably_ui/core/images/cust-logo-ausopen-col-pos@2x.png"),
          },
        }
      end
          ...
          hubspot: {
            columns: [
              ...
              },
              {
                ...
                text: "Ably’s realtime platform seamlessly supports HubSpot's entire realtime needs and helps us meet technical, business, and product development, requirements.",
                button: {
          ...
          lightspeed: {
            columns: [
              ...
              },
              {
                ...
                text: "Lightspeed Systems relies on Ably’s realtime platform to enable realtime student safety for remote and classroom learning solutions at scale.",
                button: {
                  label: "View case study",
                  href: "#"
                }
          ...
          australian_open: {
            columns: [
              ...
              },
              {
                ...
                text: "Only Ably meets The Australian Open’s exacting performance targets, reliably delivering realtime scores, updates and commentary to a huge global fan base.",
                button: {
                  label: "View case study",
                  href: "#"
                }
          ...
          split: {
            columns: [
              ...
              },
              {
                ...
                text: "Ably’s realtime platform and SSE support enable Split to deliver more than one trillion business-critical feature flags to tens of millions of client apps every month.",
                button: {
                  label: "View case study",
                  href: "#"
                }
