...
const DEFAULT_MENU_LINK_STYLING =
  "ui-text-label3 font-bold text-neutral-1000 dark:neutral-300 hover:text-neutral-1300 dark:hover:text-neutral-000 px-12 py-8 flex items-center justify-between";
