...
const styles = {
  ...
  gui: [
    { label: "Button label 1", className: "ui-text-label1" },
    { label: "Button label 2", className: "ui-text-label2" },
    { label: "Button label 3", className: "ui-text-label3" },
    { label: "Button label 4", className: "ui-text-label4" },
    { label: "Menu label 1", className: "ui-text-label1" },
    { label: "Menu label 2", className: "ui-text-label2" },
    { label: "Menu label 3", className: "ui-text-label3" },
    { label: "Menu label 4", className: "ui-text-label4" },
